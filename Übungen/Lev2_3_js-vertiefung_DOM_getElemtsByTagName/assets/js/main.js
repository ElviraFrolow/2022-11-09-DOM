let homeBtn = document.getElementById("navHome");
let newsBtn = document.getElementById("navNews");
let contactBtn = document.getElementById("navContact");
let changeBtn = document.getElementById("navChange");

const changeColor = () => {
  homeBtn.style.backgroundColor = "pink";
  newsBtn.style.backgroundColor = "green";
